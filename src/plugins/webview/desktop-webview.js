...
var DesktopWebview = (function () {
    ...
    DesktopWebview.prototype.addEventListener = function (type, callback) {
        proxy_1.AWProxy.exec(util_1.noop, util_1.noop, "AWWebView", "addEventListener", [this.id, type, callback]);
    };
    DesktopWebview.prototype.removeEventListener = function (type, callback) {
        proxy_1.AWProxy.exec(util_1.noop, util_1.noop, "AWWebView", "removeEventListener", [this.id, type, callback]);
    };
    DesktopWebview.prototype.close = function () {
        proxy_1.AWProxy.exec(util_1.noop, util_1.noop, "AWWebView", "close", [this.id]);
    };
    DesktopWebview.prototype.show = function () {
        proxy_1.AWProxy.exec(util_1.noop, util_1.noop, "AWWebView", "show", [this.id]);
    };
    DesktopWebview.prototype.open = function (url, target, options) {
        proxy_1.AWProxy.exec(util_1.noop, util_1.noop, "AWWebView", "open", [this.id, url, target, options]);
        return this;
    };
    DesktopWebview.prototype.executeScript = function (script, callback) {
        proxy_1.AWProxy.exec(callback, util_1.noop, "AWWebView", "executeScript", [this.id, script]);
    };
    DesktopWebview.prototype.insertCSS = function (css, callback) {
        proxy_1.AWProxy.exec(callback, util_1.noop, "AWWebView", "insertCSS", [this.id, css]);
    };
